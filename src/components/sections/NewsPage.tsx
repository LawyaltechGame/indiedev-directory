...
import { fetchNews, type WordPressPost } from '../../services/wordpress';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && !error && posts.length === 0 && (
          <div className="bg-[rgba(20,28,42,0.6)] border border-white/8 rounded-2xl p-12 text-center">
            ...
            <h2 className="text-2xl font-bold mb-3 text-cyan-100">No News Yet</h2>
            <p className="text-cyan-200/70">
              News articles will appear here once the WordPress API is connected.
            </p>
          </div>
        )}
