...
export function ContentPostDetail() {
  ...
  const isNews = post.categories?.includes(130); // News category ID
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              {author && (
                <>
                  ...
                  <span className="text-sm text-cyan-300 font-semibold">By {author.name}</span>
                </>
              )}
            </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/10">
                <div className="flex gap-6 items-start bg-[rgba(13,21,36,0.65)] border border-white/8 rounded-2xl p-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-cyan-100 mb-2">{author.name}</h3>
                    {author.description && (
                      <p className="text-cyan-200/70 leading-relaxed">{author.description}</p>
                    )}
                  </div>
                </div>
              </div>
